  ...
  const contactInfo = [
    {
      title: "Phone",
      details: [
        "Customer Support: +91 9354146523",
        "Technical Support: +91 9354146523"
      ],
      icon: (
    ...
    },
    {
      title: "Email",
      details: [
        "General Inquiries: info@callmibro.com",
        "Support: support@callmibro.com"
      ],
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="bg-[#111] border border-[#333] rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-[#e60012]/10 transition-shadow">
      ...
      <div className="space-y-6">
        {contactInfo.map((item, index) => (
          ...
          >
            <div className="bg-gradient-to-r from-[#e60012] to-[#ff6b6b] p-3 rounded-lg mr-4 flex-shrink-0">
