    ...
    <footer className="bg-black pt-12 pb-6 border-t border-[#e60012]">
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/spare-parts" className="text-gray-400 hover:text-white">Spare Parts</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-[#333] pt-6 mt-8">
          <p className="text-gray-500 text-sm text-center">&copy; {new Date().getFullYear()} CallMiBro. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
