  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="w-full bg-[#e60012] text-white py-2 rounded hover:bg-[#b3000f] transition-colors mt-2"
        >
        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-2 gap-3 mt-4">
            <button
              type="button"
              className="bg-[#222] hover:bg-[#333] text-white py-2 px-4 rounded border border-[#333] transition-colors flex items-center justify-center"
