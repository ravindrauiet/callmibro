export default function ServiceCard({ title, description, icon }) {
  return (
    <div className="bg-[#111] rounded-lg p-4 sm:p-8 flex flex-col items-center text-center">
      ...
      <button className="mt-auto border border-[#e60012] text-[#e60012] hover:bg-[#e60012] hover:text-white transition-colors duration-300 rounded-md px-4 sm:px-6 py-1.5 sm:py-2 text-sm sm:text-base">
        Book Now
      </button>
    </div>
  )
