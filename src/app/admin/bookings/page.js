  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <h2 className="text-2xl font-bold" style={{ color: 'var(--text-main)' }}>Bookings Management</h2>
      ...
      <div className="relative">
        <input
          type="text"
          placeholder="Search bookings by ID, service, customer name, email, or phone..."
          value={searchTerm}
